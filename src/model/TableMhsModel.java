 ...
 * @author User
 */
public class TableMhsModel extends AbstractTableModel {
    ...
    public Object getValueAt(int a, int b) {
        ...
        switch (b) {
            case 0:
                return list.get(b).getKode();
            case 1:
                return list.get(b).getNim();
            case 2:
                return list.get(b).getNama();
            case 3:
                return list.get(b).getFakultas();
            case 4:
                return list.get(b).getProdi();
            case 5:
                return list.get(b).getNohp();
            case 6:
                return list.get(b).getEmail();
            default:
                return null;
